...
11. Какие проблемы/задачи решает 2FA, а какие не решает?
12. Раскройте содержание принципов разумной достаточности и своевременности в информационной безопасности.
13. Какие вы видите противоречия при сопоставлении удобства и безопасности? Могут ли эти свойства сочетаться, если да, то как?
13. Как вы понимаете концепции модели угроз и модели нарушителя?
14. Объясните принцип "ни одна система не является абсолютно защищенной". Выскажите своё аргуметированное согласие или несогласие.
...
7. Что такое AMSI, какие задачи решает? 
...
2. Что такое cgroups и namespaces? Какие небезопасные конфигурации существуют?
3. Какие ошибки про написании Dokerfile может совершит разработчик?
4. Какие методы выхода из контейнера вам известны?
...
## Сетевые штуки
1. Расскажите доступных способах эксфильтрации данных из внутренней корпоративной сети наружу. Какие могут быть ограничивающие факторы или наоборот дающие возможности?
2. Расскажите доступных способах инфильтрации данных во внутреннюю корпоративную сеть снаружи. Какие могут быть ограничивающие факторы или наоборот дающие возможности?
3. Расскажите о том, как и с помощью каких инструментов/протоколов/техник вы бы организовывали тоннели для передачи данных (aka pivoting)
4. Расскажите на какие сетевые протоколы вы обращаете особенное внимание во время анализа сетевого трафика внутри корпоративной сети и почему?
5. Расскажите о сетевых атаках на канальном и сетевом уровнях. Какие существуют бизнес-риски и дальнейшие шаги после успешной эксплуатации?

## Недоменные уязвимости
1. Расскажите об известных вам атаках на сетевое оборудование. Какие протоколы могут использоваться?
2. Какие уязвимости баз данных вам известны? Приведите примеры эксплуатации и пост-эксплуатации
3. Расскажите об атаках на сетевые принтеры. Какие векторы развития атаки возможно и какой потенциальный импакт?
4. Расскажите о распространенных недоменных сервисных уязвимостях во внутренней сети
...
10. Расскажите об алгоритме PBKDF. Для чего используется и какую отличительную особенность имеет?
...
11. Какие методологии пентеста мобильных приложений вам известны?
12. Какие ошибки на уровне криптографии могут быть в приложении? 
13. Что делать, если стандартные способы обхода SSL-Pinning не работают?

## iOS
1. Что такое Keychain? Какие флаги для храния данных в keychain вам известны? Какие наиболее, а какие наименее безопасные?
2. Как найти, в какую папку установилось iOS приложение с помощью терминала?
3. За что отвечает файл info.plist?
4. Какие инструменты для исследование безопасности iOS приложений вы знаете? Какие есть плюсы и минусы?   
