...
## Linux 
1. Какая информация находится в файле /etc/passwd? Как эта информация может быть использована для повышения привилегий на системе? Что и как влияет на содержимое этого файла?
...
14. Расскажите о какой-нибудь более специфичной уязвимости - CSS-инъекция, XSSI, XSLT, Prototype Pollution.
...
4. Каким bloodhound-сборщиком пользуетесь? Назовите известные вам рёбра (edges) в bloodhound и как их эксплуатировать?
