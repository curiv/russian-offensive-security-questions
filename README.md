...
8. Расскажите о возможных атаках на стандарт OAuth2.
9. CORS, SOP, CSP, Security Headers. Для чего они нужны и как корректно должны быть настроены? Отличия SameSite от SameOrigin. 
10. Небезопасная десериализация в различных языках программирования. Какие библиотеки и в каких языках программирования подвержены ей? В каких случаях и какого импакта возможно добиться?
11. Расскажите о более специфичные уязвимости - CSS-инъекция, XSSI, XSLT, Prototype Pollution.
